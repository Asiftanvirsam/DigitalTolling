...
public class RegisterActivity extends AppCompatActivity {
   ...
   private FirebaseAuth mAuth;
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( username.isEmpty() || email.isEmpty() || nid.isEmpty() || password.isEmpty() || !password.equals(password2)) {
                    ...
                    CreateUserAccount(username,email,nid,password);
    ...
    private void CreateUserAccount(final String username, final String email, final String nid, String password) {
...
//                .into(imageUserPhoto);
    ...
    private void createUser(String name,String email,String nid){
